...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Enoch Mwenda
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">AI Engineer</h3>
        <p className="home__description">I am a mission-driven full-stack engineer.Currently, I am majoring in artificial intelligence and machine learning.
         </p>
